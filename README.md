...
🤖 **AI Engineer & aspiring Product Owner** — passionate about building intelligent systems and shipping products that solve real problems.

- 🔭 Currently working on **"Voice of Customer" Feedback Synthesizer**
...
|------|---------------------|
| 🤖 **AI Engineering** | Designing, training & deploying ML models into production |
| 📦 **Product Ownership** | Translating user needs into roadmaps and shipped features |
| 🔬 **Continuous Learning** | Staying on the frontier of LLMs, agents & applied AI |
| 🌍 **Real-World Impact** | Building things people actually use |
...
[![Portfolio](https://img.shields.io/badge/Portfolio-2E9EF7?style=for-the-badge&logo=google-chrome&logoColor=white)](www.linkedin.com/in/balasubramaniam-theetharappan-b22a1612a/)
...
<div align="center">
  <i>⭐️ "Passionate about building AI that blends data, creativity & impact."</i>
</div>
